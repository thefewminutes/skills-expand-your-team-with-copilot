...
initial_activities = {
    ...
    "Manga Maniacs": {
        "description": "Unleash your inner otaku! Join fellow manga enthusiasts to dive into epic adventures, legendary heroes, and mind-bending storylines from the most incredible Japanese manga worlds.",
